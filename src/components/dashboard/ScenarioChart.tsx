...
import { RothConversionType, type RetirementYear, type Scenario } from '../../models/RetirementTypes';

import { formatMoney } from '../../utils/format';

export function ScenarioChart({ rows, scenario }: { rows: RetirementYear[]; scenario: Scenario }) {
  ...
  const customOrder = ['Traditional', 'Roth', 'Total'];
